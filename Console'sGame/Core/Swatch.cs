...
namespace Console_sGame.Core
{
    public static class Swatch
    {
        ...
        public static RLColor SecondaryDarkest = new RLColor(51, 56, 64);
        public static RLColor SecondaryDarker = new RLColor(31, 38, 47);
        ...
        public static RLColor ComlimentLighter = new RLColor(158, 147, 138);
        public static RLColor Comliment = new RLColor(129, 116, 107);
        public static RLColor ComlimentDarkest = new RLColor(97, 84, 75);
        public static RLColor ComlimentDarker = new RLColor(97, 89, 75);
